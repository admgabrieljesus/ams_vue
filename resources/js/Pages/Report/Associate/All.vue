	...
	<app-layout>
		<div class="ml-2 mt-2 w-full">
			<section class="py-1 bg-blueGray-50">
				<div class="w-full mb-2 xl:mb-0 px-2 mx-auto mt-2">
					<div
					...
					>
						<div class="rounded-t mb-0 px-2 py-3 border-0">
							<div class="flex flex-wrap items-center">
								<div class="relative w-full px-s flex-grow flex-1">
						...
						<div class="block w-full overflow-x-auto">
							<table class="items-center bg-transparent w-full border-collapse">
								...
								<tbody
									...
									:key="associate.addresses.address"
								>
									<tr>
										<th
										...
										>
                                        <p v-for="address in associate.addresses" :key="address.id">
                                        ...
                                        <td  
											class="border-t-0 px-6 align-center border-l-0 border-r-0 text-sm whitespace-nowrap p-1"
										>
											<p v-for="phone in associate.phones" :key="phone.id">
                                        ...
                                        <td  
											class="border-t-0 px-6 align-center border-l-0 border-r-0 text-sm whitespace-nowrap p-1"
										>
                                        <p  v-for="email in associate.emails" :key="email.id">
											{{ email.email }}
                                            </p>
										</td>
