<template>
	<jet-action-section>
		...
		<template #description>
			Gerencie e desconecte suas sessões ativas em outros navegadores e
			dispositivos.
		</template>
		...
		<template #content>
			<div class="max-w-xl text-sm text-gray-600">
				...
				achar que sua conta foi comprometida, você também deve atualizar sua
				senha.
			</div>
			...
			<jet-dialog-modal :show="confirmingLogout" @close="closeModal">
				<template #title> Sair de Outros Navegadores </template>

				<template #content>
					Digite sua senha para confirmar que deseja sair de suas outras sessões
