...
Certifique-se de que sua conta esteja usando uma senha longa e aleatória para se manter seguro.<br>   O campo senha deve ter pelo menos 8 caracteres e conter pelo menos um caractere maiúsculo e um número.      </template>
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password" value="Senha Nova" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password_confirmation" value="Confirme Senha Nova" />
